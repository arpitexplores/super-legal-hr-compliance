...
5. Rename the extracted folder from `super-legal-hr-compliance-main` to `super-legal-hr-compliance`.
6. Copy the renamed `super-legal-hr-compliance` folder into your agent's skills directory.
...
This repository is the `super-legal-hr-compliance` skill. Keep the full `super-legal-hr-compliance` folder together when installing it.
